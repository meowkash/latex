...
% Do not use a header or footer on chapter pages.
...
% When formatting numbers in an enumerated list, replace #1 with the commented part to get circled numbers.
% You can also use the circled command for, as an example, page numbers.
